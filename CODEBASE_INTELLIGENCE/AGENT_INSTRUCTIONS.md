...
3. `docs/multi-tenant-bookstore-marketplace/README.md`
4. `docs/multi-tenant-bookstore-marketplace/DOC-13-implementation-tracker.md`
5. the active phase tracker under `docs/multi-tenant-bookstore-marketplace/implementation/`
