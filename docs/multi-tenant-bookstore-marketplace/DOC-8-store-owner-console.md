...
> **Unit 6H correction checkpoint — 2026-09-12:** The duplicate warning is locally
> integrated into the Owner capture flow. Dismissal is local-only and leaves a
...
> the existing `VirtualizedList` `act(...)` warning recorded separately. M60 is
> not remotely applied; F-01 is retracted and F-02/F-03 are corrected locally.
