...
- **Latest runtime state:** M43, M44, M45, M46, M47, and the forward trusted-role compatibility correction M48 remain live exactly once as `20260816122822`, `20260816122901`, `20260816122929`, `20260816150126`, `20260817073341`, and `20260817075825`. M47 revoked all non-owner execution on the obsolete projection-row Marketplace RPCs; M48 precisely retains the customer-role revocation while restoring only `service_role` `EXECUTE`. The v2 JSON discovery functions remain unchanged. Edge v8 remains the only deployed `phase9-owner-ingestion` version, with JWT verification enabled, and still serves source HEAD `5cfc08ebbe8b20a94cbf6d0616d894a840bc8882`; repository HEAD `f4a9e858396474dcd08123eb976a47b019ef26f8` contains the proven M46 correction. No Edge redeploy or other function/service change occurred.
...
- **Current work-unit plan:** The [Unit 8 bookstore-first Marketplace SDD](./phase-9-image-inventory/work-units/08-marketplace-bookstore-first-sdd.md) remains the authority. Unit 8 is repository-complete and ready for closure after the final Unit 7/8 public-media order reconciliation. Four logical local commits are prepared; M49-M51 remain repository-only and unapplied. Push/merge, migration-history reconciliation, Vault provisioning, live application/verification, and deployment remain separate work.
