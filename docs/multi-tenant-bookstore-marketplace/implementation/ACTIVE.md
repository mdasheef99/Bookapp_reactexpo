...
- **Current work-unit plan:** Unit 5B is independently approved/merged and fixture/mock verified only. [Unit 5C-1](./phase-9-image-inventory/trackers/13-unit5c1-variant-contract-evidence.md) implements the optional provider-neutral multilingual proposal contract and fixture-gated independent validation seam; exact-tip review remains the merge gate. Current Gemini generation, selected-language runtime, strict `p9-vision-v2`, live M01 alias schema, and positive-price publication remain unchanged. No provider call, migration, persistence, UI, index, inventory, publication, deployment, or commerce activity is authorized.
