...
- **Current work-unit plan:** The [Unit 6 SDD](./phase-9-image-inventory/work-units/06-owner-capture-review-recovery-ux-sdd.md), [design evidence](./phase-9-image-inventory/trackers/18-unit6-owner-ux-design-evidence.md), and contract matrix remain authoritative. Unit 6A is merged/live-verified through M29, Unit 6B is merged at `9ef9eb3`, Unit 6C is merged through `092562d`, Unit 6D remains implemented at `c363b60`, and Unit 6E is finalized at `8bceab2`. M30 is live exactly once as `20260801093048 marketplace_phase9_unit6e_review_corrections`. WU1 is applied exactly once as `20260803221216 marketplace_phase9_owner_inventory_read_boundary`; its [addendum](./phase-9-image-inventory/work-units/owner-inventory-read-boundary-wu1-sdd.md) and [tracker 25](./phase-9-image-inventory/trackers/25-owner-inventory-read-boundary-wu1-evidence.md) record live readback. WU2 is locally complete: its [addendum](./phase-9-image-inventory/work-units/owner-inventory-read-client-wu2-sdd.md) and [tracker 26](./phase-9-image-inventory/trackers/26-owner-inventory-read-client-wu2-evidence.md) record the read-only Owner `/inventory` RPC cutover; a disposable authenticated browser session covers positive read smoke while the full runtime matrix remains deferred. Unit 6F browser/readback evidence is in tracker 24, which also records the fixture-backed fifteen-card UI check. The Unit 4B server configuration/startup check did not perform provider inference, and the production Gemini-to-metadata-to-review path remains unproven. Dashboard remediation and Unit 7 remain separately gated. The next action is a read-only vertical integration audit under the existing Unit 4B/5A/5B authority.
