...
- **Current work-unit plan:** [Package 1 approved database design](./phase-9-image-inventory/work-units/01-package1-database-design.md); M01-M08 live once, verification blocked because M08 revoked anonymous execution from the three M07 discovery RPCs
