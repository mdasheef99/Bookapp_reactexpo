...
- **Current work-unit plan:** The [Unit 8 bookstore-first Marketplace SDD](./phase-9-image-inventory/work-units/08-marketplace-bookstore-first-sdd.md) remains the authority. Unit 8 is live-verified on `Bookconnect_reactexpo`; the three forward migrations, dedicated cursor secret, connected acceptance, and strict media invariant are recorded in [connected rollout evidence](./phase-9-image-inventory/supporting/unit8-connected-rollout-2026-08-21.md). The release commit `4c1d98d` is integrated into and pushed on `main`; historical migration IDs remain untouched. Select the next Phase 9 work unit separately.
