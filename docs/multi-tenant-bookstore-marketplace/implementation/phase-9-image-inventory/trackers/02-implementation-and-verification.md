...
**Status:** `m16_live_pg17_maintain_correction_required`
...
| 5A | [Metadata foundation](../work-units/05a-metadata-foundation-handoff.md): provider-neutral local-first routing/cache/coalescing, ISBN validation, coherent selection, and attempt/cost lineage | `m16_live_pg17_maintain_correction_required` | M16 live once; six DML/DDL privileges removed, but PG17 MAINTAIN remains; M17 and Unit 5B separately gated |
