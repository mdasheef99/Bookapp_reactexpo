...
| 7B | [Safe publication/projection after private inventory creation](../work-units/07b-publication-sdd.md) | `review_candidate_pushed_luna_review_pending` | complete Luna xhigh review; run all three deferred `REQUIRED_BEFORE_LIVE` gates on the final post-correction SHA before Stage J |
