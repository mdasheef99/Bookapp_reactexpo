...
**Status:** `unit6c_locally_complete_unit6d_separately_gated`; **last updated:** 2026-07-31
**Active work unit:** `unit6c_closeout_unit6d_separately_gated`. Unit 6A is merged/live-verified through M29, Unit 6B is merged at feature commit `9ef9eb3`, and Unit 6C is locally complete at implementation commit `b87469d`. The [Unit 6 design](../work-units/06-owner-capture-review-recovery-ux-sdd.md), [contract matrix](../work-units/06-owner-capture-review-recovery-contract-matrix.md), [Unit 6A evidence](./19-unit6a-owner-safe-backend-evidence.md), [Unit 6B evidence](./20-unit6b-route-query-cache-evidence.md), and [Unit 6C evidence](./21-unit6c-capture-upload-recovery-evidence.md) are authoritative. Unit 6D requires separate authorization; Units 6E-6F and Unit 7 remain gated. WU0B history preserves `definition_independently_approved_awaiting_implementation_authorization`, `implementation_authorized`, and review.
## Work units
...
| 6 | [Owner capture/review/recovery UX](../work-units/06-owner-capture-review-recovery-ux-sdd.md), split 6A-6F | [`unit6b_locally_complete`](./20-unit6b-route-query-cache-evidence.md) | Unit 6C capture/preview/progress/recovery only is next; migration/deploy separately gated |
...
- Completed: implementation commit `b87469d`; Inventory Start/Resume, scan workflow context, fixed-default setup, camera/gallery intake, local validation, cancellable signed transport, explicit byte-versus-registration state, same-command registration replay, bounded capability reuse/renewal, progress polling, recovery states, terminal handoff, and repeatable identity cleanup
...
- Next authorized action and gate: bounded evidence commit and authorized fast-forward merge only; Phase 9 Unit 6D then requires separate authorization, and migrations, Supabase/Storage mutation, deployment, Units 6E-6F, and Unit 7 remain separately gated
