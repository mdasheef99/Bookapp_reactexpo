...
**Status:** `unit6b_locally_complete_unit6c_next_authorized`; **last updated:** 2026-07-30
**Active work unit:** `unit6c_capture_preview_progress_recovery_ux`. Unit 6A is merged/live-verified through M29, and Unit 6B is locally complete at feature commit `9ef9eb3`. The [Unit 6 design](../work-units/06-owner-capture-review-recovery-ux-sdd.md), [contract matrix](../work-units/06-owner-capture-review-recovery-contract-matrix.md), [Unit 6A evidence](./19-unit6a-owner-safe-backend-evidence.md), and [Unit 6B evidence](./20-unit6b-route-query-cache-evidence.md) are authoritative. Unit 6C only is next; Units 6D-6F and Unit 7 remain gated. WU0B history preserves `definition_independently_approved_awaiting_implementation_authorization`, `implementation_authorized`, and review.
## Work units
