...
**Status:** `unit6_design_approved_unit6a_next_authorized`; **last updated:** 2026-07-30
**Active work unit:** `unit6a_owner_safe_backend_contract_foundation`. Unit 5C-5/5C-6 is merged on `main`, M24-M28 are live exactly once, and no language is benchmarked/approved/enabled. The [Unit 6 design](../work-units/06-owner-capture-review-recovery-ux-sdd.md), [contract matrix](../work-units/06-owner-capture-review-recovery-contract-matrix.md), and [tracker 18](./18-unit6-owner-ux-design-evidence.md) are approved; Unit 6 implementation has not started. WU0B history preserves `definition_independently_approved_awaiting_implementation_authorization`, `implementation_authorized`, and review.
## Work units
...
| 5B/5C | Google Books primary adapter / [Unit 5C Lite multilingual variants](../work-units/05c-lite-multilingual-search-variants-sdd.md) | [`5B merged_fixture_verified_provider_deferred`](./11-unit5b-implementation-evidence.md) / [`5C-5/5C-6 merged and live`](./17-unit5c5-6-owner-rollout-backend-evidence.md) | M18-M28 live once; M29 absent; no language enabled |
| 6 | [Owner capture/review/recovery UX](../work-units/06-owner-capture-review-recovery-ux-sdd.md), split 6A-6F | [`approved_design_authority_implementation_not_started`](./18-unit6-owner-ux-design-evidence.md) | Unit 6A Owner-safe backend contract foundation only is next; migration/deploy separately gated |
