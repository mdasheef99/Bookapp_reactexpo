...
**Status:** `unit6d_merged_unit6e_separately_gated`; **last updated:** 2026-07-31
**Active work unit:** `unit6e_awaiting_separate_authorization`. Unit 6A is merged/live-verified through M29, Unit 6B is merged at `9ef9eb3`, Unit 6C is merged through `092562d`, and Unit 6D is implemented at `c363b60`. The [Unit 6 design](../work-units/06-owner-capture-review-recovery-ux-sdd.md), [contract matrix](../work-units/06-owner-capture-review-recovery-contract-matrix.md), and [Unit 6D evidence](./22-unit6d-candidate-review-evidence.md) are authoritative. Unit 6E requires separate authorization; Unit 6F and Unit 7 remain gated. WU0B history preserves `definition_independently_approved_awaiting_implementation_authorization`, `implementation_authorized`, and review.
## Work units
...
| 6 | [Owner capture/review/recovery UX](../work-units/06-owner-capture-review-recovery-ux-sdd.md), split 6A-6F | [`unit6d_complete`](./22-unit6d-candidate-review-evidence.md) | Unit 6E only is next eligible and separately gated; migration/deploy separately gated |
