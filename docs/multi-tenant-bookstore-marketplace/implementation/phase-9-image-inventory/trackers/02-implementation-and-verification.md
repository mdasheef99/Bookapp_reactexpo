...
**Active work unit:** `unit5c2_variant_persistence`. Unit 5C-1 is independently approved/merged. Unit 5C-2 private proposal persistence and its bounded M19 replay fence are live-verified; independent review of the exact staged tree precedes commit/push. Provider generation, activation, search/UI, inventory/listing creation, publication, and deployment remain unauthorized. WU0B history preserves `definition_independently_approved_awaiting_implementation_authorization`, `implementation_authorized`, and review.
## Work units
...
| 5B/5C | Google Books primary adapter / [Unit 5C Lite multilingual variants](../work-units/05c-lite-multilingual-search-variants-sdd.md) | [`5B merged_fixture_verified_provider_deferred`](./11-unit5b-implementation-evidence.md) / [`5C-2 live_verified_candidate_review_gate`](./14-unit5c2-variant-persistence-evidence.md) | 5C-1 merged at `8aadf178`; M18 private proposed-only persistence is live once as `20260729004216`; generation, activation, search/UI, inventory, publication, and commerce remain unchanged |
...
- M18 is live once as `20260729004216`; M19 is live once as `20260729020008` and fences changed accepted envelopes. Schema/ACL/RPC plus proposed-only/exact-replay/changed-replay/mismatch/store-scope/rollback-cleanup smoke passed. Final corrected focused Jest passed 15/15, six-suite PGlite passed 74/74, scoped TypeScript passed, and continuity passed 195 definitions/zero duplicates/zero missing; full TypeScript timed out. M18/M19 are the only Unit 5C-2 external mutations; aliases/product data remain unchanged. Full evidence, files, deviations, docs, boundaries, and the staged-tree review gate are in [tracker 14](./14-unit5c2-variant-persistence-evidence.md).
