...
**Current milestone:** M35 and Owner Edge v3 remain live-verified; complete current Unit 6 ingestion source is being reconciled for controlled publication to `main`
...
**Next authorized action:** complete local verification and independent review, assemble a clean candidate from fresh `origin/main`, then push that exact verified candidate normally to `origin/main`
