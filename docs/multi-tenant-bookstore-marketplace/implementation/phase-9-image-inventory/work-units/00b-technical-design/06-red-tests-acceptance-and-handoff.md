...
| RT-ALIAS-01 | current M01 schema plus Unit 5C target; DAT-11/13/14 | variant parser/storage mapping; contract/database | field mismatch, stale source, global scope, deterministic-key row, unapproved translation, already-Latin duplicate | only reconciled active store-scoped variants search; current rows remain truthfully mapped | provenance/status only, never variant text | U5/U8 |
...
| RT-LANGUAGE-01 | current selected-language runtime and Unit 5C target; EXT-04/05/20 | C01,C03/input worker plus future sidecar; contract/integration | optional hint conflicts with mixed field languages/scripts | current behavior remains stable; target preserves per-field values without model switching or hint-forcing | language policy/version and bounded outcome only | U2/U4/U5 |
| RT-VARIANT-01 | MAS-18/19; DAT-10–14; REV-22 | Unit 5C validation/reconciliation | missing/invalid sidecar, independent title/author confirmation, material source edit, experimental language, store mismatch | extraction remains valid; unsafe proposals remain proposed/stale/rejected and non-searchable | no raw source text in telemetry | U5 |
