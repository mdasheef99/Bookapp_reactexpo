...
locally corrected on `8340647`; M60 was applied only to a disposable PostgreSQL
18.4 cluster and is not remotely applied. F-01 is retracted and F-02/F-03 are
corrected locally. Independent-connection concurrency and existing regression
acceptance pass; connected Edge/Storage verification remains the rollout gate.
