...
> **Unit 6H correction checkpoint — 2026-09-12:** The duplicate-image confirmation
> implementation is locally corrected but not rolled out. It preserves the
...
> existing inventory or reuse an older scan. M60 is local-only; F-01 is retracted
> and F-02/F-03 are corrected locally. Disposable independent-connection
