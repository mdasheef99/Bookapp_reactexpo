...
### 2.1 Standard Users
**Free Tier:**
- Unlimited eligible Book Club memberships (`access_level = all`)
- Can participate fully in member activities after joining an eligible club (chat, vote, RSVP, etc.)
- Cannot be promoted to Moderator or Admin role in clubs
- Cannot create clubs
...
**Pro Tier ($2.99/month):**
- Unlimited eligible Book Club memberships (`access_level = all` or `pro`)
- Can create up to 5 book clubs
- Can be promoted to Moderator or Admin role in eligible clubs
- Priority support
- Early access to new features

**Pro+ Tier ($4.99/month):**
- Unlimited eligible Book Club memberships (`access_level = all`, `pro`, or `pro_plus`)
...
- **Moderator**: Assigned by Admin, moderation tools (requires Pro/Pro+ tier)
- **Member**: Standard participation (available when the user's membership tier satisfies the club's `access_level`)

**Role Requirements:**
- **Admin role:** Requires active Pro or Pro+ subscription
- **Moderator role:** Requires active Pro or Pro+ subscription
- **Member role:** Available to users whose membership tier satisfies the club's `access_level`
