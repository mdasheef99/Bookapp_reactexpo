export const hindiAliasResult = {
  ...
  aliases: [
    ...
    { text: 'Godan', language: 'en-Latn', kind: 'common_title', source: 'recorded_fixture', source_version: '1.0.0', confidence: 0.85, approval_status: 'proposed' },
  ],
};
...
export const retainedAliasRows = [
  ...
  { text: 'Godaan Novel', language: 'en-Latn', kind: 'common_title', source: 'fixture_owner', source_version: '1.0.0', source_type: 'owner_verified', confidence: null, approval_status: 'approved' },
];
