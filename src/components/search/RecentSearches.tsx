...
export const RecentSearchItem = ({ query, onPress, onRemove, colors }: RecentSearchItemProps) => (
    <TouchableOpacity
        onPress={onPress}
        style={{
            flexDirection: 'row',
...
export const RecentSearches = ({ searches, onSearch, onRemove, colors }: RecentSearchesProps) => {
